...
#    print(Tm)
    ...
    #print("sua posicao e: " + str(x) + " mm em x")
    #print("sua posicao e: " + str(y) + " mm em y")
    #print("sua posicao e: " + str(z) + " mm em z")
    
    objetivo = [-35,5,-5,35,-135,-95]
    
    if objetivo[0]< x < objetivo[1]:
        if objetivo[2] < y < objetivo[3]:
            if objetivo[4] < z < objetivo[5]:
                print("Atingiu o objetivo")
            else:
                print("mova x em " + str(-15-x))
                print("mova y em " + str(15-y))
                print("mova z em" + str(-115-z))
        else:
            print("mova x em " + str(-15-x))
            print("mova y em " + str(15-y))
            print("mova z em" + str(-115-z))
